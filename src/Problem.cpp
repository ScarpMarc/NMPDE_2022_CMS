...
void Problem::solve()
{
  ...
  SolverControl solver_control(simulation_settings.max_solver_iteration_amt, simulation_settings.desired_solver_precision * system_rhs.l2_norm() /*, true*/);
...
void Problem::output()
{
  ...
  const std::string output_file_name = "ptero_out";
